...
from battlezone.terrain.lgt import (  # noqa: F401  (the LGT codec lives in the core)
    LGT_AMBIENT_FRACTION, LGT_RANGE_FRACTION, lgt_to_brightness, read_lgt, write_lgt,
)
...
# LGT ambient floor (see battlezone.terrain.lgt): 0 = 25% brightness, 255 = 100%.
